...
<ul class="sidenav" id="mobile-demo">
  <li class="tab"><a class="active" href="#homepage"><i class="material-icons">home</i> Homepage</a></li>
  <li class="tab"><a href="#contact"><i class="material-icons">contact_phone</i> Contact</a></li>
  <li class="tab"><a href="#about"><i class="material-icons">info</i> About</a></li>
  <li class="tab"><a href="#login"><i class="material-icons">lock</i> Login</a></li>
  <li class="tab"><a href="#inquire"><i class="material-icons">border_color</i> Inquire</a></li>
</ul>