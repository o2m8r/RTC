    ...
    <ul id="nav-mobile" class="right hide-on-med-and-down">
      <div class="nav-content">
        <ul class="tabs tabs-transparent">
          <li class="tab"><a class="active" href="orders" onclick="javascript:window.location.href='orders';"><i class="material-icons">shopping_cart</i> <span class="new badge">4</span></a></li>
