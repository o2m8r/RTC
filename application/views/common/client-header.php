<nav class="nav-extended">
  <div class="nav-wrapper container">
    ...
    <ul id="nav-mobile" class="right hide-on-med-and-down">
      <li><a class="active" href="orders" onclick="javascript:window.location.href='orders';"><i class="material-icons">shopping_cart</i> <span class="new badge blue" style="position: absolute; top: 1px;">0</span></a></li>
...
<ul class="sidenav" id="mobile-demo">
  <li class="tab"><a class="active" href="orders"><i class="material-icons">shopping_cart</i> Orders <span class="new badge">4</span></a></li>
